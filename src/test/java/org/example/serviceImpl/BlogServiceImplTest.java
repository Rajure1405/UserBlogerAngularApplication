...
class BlogServiceImplTest {
    ...
    void getBlogByIdTest() {
        ...
        blog = blog1;
        when(blogRepository.findById(1)).thenReturn(Optional.of(new BlogEntity(1, "Pavsala", "Sundar Pavsala", "Rohit Rajure", "N", user1)));
        ...
        assertEquals("Rohit Rajure", blogs.getBody().getPublishBy());
